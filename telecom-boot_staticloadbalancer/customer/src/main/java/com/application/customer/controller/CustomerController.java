...
import com.application.customer.LoadBalancerConfig;
...
//            friendFamilyUrl = ffservices.get(0).getUri().toString();
        ...
        List<Long> friends = restTemplate.getForObject("http://MyloadBalancer/customers/"+phoneNo+"/friends", List.class);
